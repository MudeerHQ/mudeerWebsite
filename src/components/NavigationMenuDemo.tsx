    ...
    >
      <Link href="/">
        <div className="flex justify-center items-center gap-3">
          ...
          <span className="text-[#010101] text-[26px] font-extrabold">{t("logo")}</span>
        </div>
      </Link>
      <div>
        <NavigationMenu>
          <NavigationMenuList dir={locale === "ar" ? "rtl" : "ltr"}>
            <NavigationMenuItem>
              ...
              <NavigationMenuContent>
                <ul className="grid gap-5 p-4 md:w-[400px] lg:w-[1150px] lg:grid-cols-[.5fr_4fr] ">
                  <li className="row-span-3">
                    <NavigationMenuLink
                      asChild
                      className=" bg-[#0D0D0D] px-5"
                      dir={locale === "ar" ? "rtl" : "ltr"}
                    >
                      <div className="pb-8 w-[280px]  rounded-2xl flex flex-col justify-start items-start">
                        <div>
            ...
            <NavigationMenuItem>
              <Link href="/pricing" legacyBehavior passHref>
                <NavigationMenuLink
                  className={`px-4 py-2 flex items-center gap-1 text-base font-semibold cursor-pointer ${
