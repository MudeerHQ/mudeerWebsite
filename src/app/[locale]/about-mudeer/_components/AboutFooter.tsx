...
export default function AboutFooter() {
  ...
  return (
    <div
      ...
      className="h-auto min-h-[500px] -mt-32 bg-[#F5F5F4] overflow-hidden max-sm:pb-20"
    >
      <div className="h-auto bg-[white]">
        <div className="w-11/12 md:w-3/4 mx-auto flex flex-col items-center gap-8 py-16 md:pt-24 text-center">
          ...
          <div className="group w-[150px] relative flex justify-center items-center gap-2 text-[#FFFFFF] bg-[#141414F5] rounded-[10px] py-2 px-3 text-base font-medium cursor-pointer hover:rounded-3xl transition-all duration-300 mb-24">
            <ArrowLeft
              color="#FFFFFF"
              size={12}
